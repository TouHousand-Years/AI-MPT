...
Piano Roll editing is off by default and remains experimental. For requirements, MCP client setup, and full instructions, see the [English User Guide](USER_GUIDE_EN.md) or [中文用户指南](USER_GUIDE_CHN.md).
