...
Piano Roll editing is off by default and remains experimental. For requirements, MCP client setup, and full instructions, see the [User Guide](USER_GUIDE_EN.md).
