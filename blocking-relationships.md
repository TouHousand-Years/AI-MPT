...
当前快照：`issues` 目录中的 25 个 issue。箭头只表示仍会影响当前开放前沿的直接阻塞关系；节点颜色区分已解决、开放和因目的地收缩而关闭的历史票据。
...
flowchart LR
    ...
    I20["20 · First useful vertical slice<br/>open · frontier"]
    I21["21 · Smallest local build loop<br/>open"]
    ...
    class I19,I20,I21,I22,I23,I24,I25 open
...
当前唯一 frontier 是 **Define the first personally useful vertical slice**。它解决后，最小本机构建循环与最小 AI Pattern capability 可以并行推进；首条路线最终汇聚到 **Prototype the first proposal-review-apply loop**。Piano Roll Focus 是该完整工作流之后的界面优化。
